    ...
    for (int i_i = 0; i_i < iterations; i_i++) {
      ...
      if (graph->partition_id == 0) {
        LOG_INFO(
            ...
            i_i, train_loss, train_acc, val_loss, val_acc, epoch_train_time, val_train_cost, gcn_run_time, train_sampler->batch_size, eval_sampler->batch_size, train_sampler->fanout[0],train_sampler->fanout[1]);
      }
